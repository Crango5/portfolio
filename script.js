...
const translations = {
    fr: {
        ...
        "cv.path": "assets/CV_Christian_FR.pdf"
    },
    en: {
        "nav.home": "Home",
        "nav.about": "About",
        ...
        "cv.path": "assets/CV_Christian_EN.pdf"
    }
};
...
function translatePage(lang) {
    ...
    if (downloadLink && translations[lang] && translations[lang]['cv.path']) {
        downloadLink.href = translations[lang]['cv.path'];
    };
